  ...
  return (
    ...
    >
      <Card padding="none" hoverable className="overflow-hidden h-full">
        <div className="h-32 bg-gradient-to-br from-primary/15 via-accent/10 to-secondary/15 flex items-center justify-center text-5xl relative">
          {product.imageEmoji}
          {!product.inStock && (
        ...
        <div className="p-3">
          <p className="font-semibold text-sm line-clamp-2 min-h-[2.5rem]">{product.name}</p>
